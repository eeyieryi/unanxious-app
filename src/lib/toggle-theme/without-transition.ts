// Source: https://reemus.dev/article/disable-css-transition-color-scheme-change#heading-ultimate-solution-for-changing-color-scheme-without-transitions

let timeoutAction: number;
let timeoutEnable: number;

// Perform a task without any css transitions
export const withoutTransition = (action: () => unknown) => {
